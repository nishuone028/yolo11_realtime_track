...
def run(
    ...
    device: str = "",
    source: str = "E:\\yolo_track\\video_\\1.mp4",
    ...
    if video_classifier_model in TorchVisionVideoClassifier.available_model_names():
        ...
        print("'fp16' is supported for HuggingFaceVideoClassifier. Setting fp16 to Ture.")
...
def parse_opt():
    ...
    parser.add_argument(
        "--source",
        type=str,
        default="E:\\yolo_track\\video_\\1.mp4",
    ...
    parser.add_argument(
        "--num-video-sequence-samples", type=int, default=32, help="number of video frames to use for classification"
    )
    ...
    parser.add_argument(
        "--video-classifier-model", type=str, default="microsoft/xclip-base-patch16-hmdb-16-shot", help="video classifier model name"
    )
    parser.add_argument(
        "--labels",
        nargs="+",
